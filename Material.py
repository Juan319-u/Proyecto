...
class Material():
    ...
    def __init__(self,titulo="",codigo=0,estado=0,tipo_material=0):#este metodo constructor nos sirve para crear objetos con atributos establecidos
        self.titulo=titulo
        self.codigo=codigo
        self.estado=estado
    ...
    def crear_nuevo_material(self):#este metodo tiene la funcion de crear materiales nuevos y dependiendo del materia guardar unos atributos
        try:
            self.estado=1
            ...
            print("Error")
    def prestar_material(self,tipo,coleccion):# este metodo tiene la funcion de hacer el prestamos de materiales y cambiar su estado dandole tambien la fecha de entrega al user
        try:
            while True:
                if self.estado==1:#disponible
                    ...
                    print(f"El articulo ya esta prestado y sera devuelto {self.fecha_inicial}")
